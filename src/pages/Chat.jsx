        ...
        <main>
            ...
            <body className=" mx-48 my-7 flex justify-between">
                <section className="w-[450px] h-[800px] shadow-lg rounded-sm ">
                    <h1 className="text-[#1f2a36] text-xl font-semibold m-5">
                        Messages
                    </h1>
                ...
                <section className="w-[990px] h-[800px] shadow-lg rounded-sm ">
                    <div className="flex justify-between items-center px-3 bg-white h-[75px] border-b-[1px] border-yellow shadow-md">
                        ...
                        <h1 className="text-[#9B9B9B]">
                            Fulltime Frontend Developer
                        </h1>
                        <ButtonWhite
                            className={ "outline-none hover:bg-grey-white" }
                            text={ "Detail Profile" }
                        />
                    </div>
                                ...
                                <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                                    <div>
                                        <span className="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-grey-white text-grey">
                                            ...
                                            Voluptate, est! Odio sint, delectus
                                            pariatur iste tempora reprehenderit
                                            quibusdam, debitis, deleniti
                                            cupiditate eius nemo veniam. Velit
                                            optio praesentium in quod id sint
                                            quas blanditiis earum. Delectus hic
                                            unde iusto debitis et id, odit,
                                            officia assumenda dolorum vitae
                                            doloremque iure aperiam alias.
                                        </span>
                                    </div>
                                </div>
                                <img
                            ...
                            <div className="flex items-end justify-end w-6/12">
                                <div className="flex text-xs gap-2 mx-2 order-2 items-end ">
                                    ...
                                    <span className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-grey-white text-grey">
                                        ...
                                        adipisicing elit. Ea voluptatum
                                        voluptate dolorum sit incidunt hic rerum
                                        veniam perspiciatis pariatur enim
                                        impedit doloribus inventore, sint
                                        laudantium quia necessitatibus ipsum
                                        voluptatem iure porro amet nihil quidem
                                        laboriosam. Eius rerum, error aperiam
                                    </span>
                                </div>
                            </div>
                        </div>
