                        ...
                        <div className="flex flex-col bg-white rounded-md shadow-md w-full lg:h-full">
                            <div className="flex flex-col items-center justify-center pt-16">
                                <img
                                    src={company}
                                    alt=""
                                    className="rounded-full lg:w-[150px] 2xl:w-[200px]"
                                />
                            ...
                            <div className="lg:pt-10 2xl:pt-20 lg:pl-10">
                                <div className="flex flex-col lg:space-y-2">
                                    <h1 className="lg:text-lg 2xl:text-4xl">
                                        Lois Tomlinson
                                    </h1>
                                    <h2 className="lg:text-sm 2xl:text-2xl">
                                        Web Developer
                                    </h2>
                        ...
                        <div className="w-full h-[751px] shadow-md bg-white mt-48 rounded-md">
                            ...
                            <form className="m-10 space-y-5">
                                <div className="space-y-3">
                                    <h1 className="font-normal text-base text-[#9EA0A5]">
                                        Nama Perushaan
                                    </h1>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <form className="">
                                        ...
                                        >
                                            ...
                                            <p className="">
                                                Atau cari untuk mengupload file
                                                dari direktorimu.
                                            </p>
                        ...
                        <div className="flex flex-col bg-white rounded-md shadow-md w-full h-full">
                            <div className="flex flex-col items-center justify-center pt-16">
                                <img
                                    src={company}
                                    alt=""
                                    className="rounded-full sm:w-[150px]"
                                />
                                <form className="flex pt-4 items-center">
                                    <HiOutlinePencil
                                        style={{
                            ...
                            <div className="pt-20 sm:mx-10">
                                <div className="flex flex-col space-y-3">
                                    ...
                                    <p className=" text-[#9EA0A5] md:text-md font-normal">
                                        Freelancer
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <div className="flex sm:space-x-10">
                                                ...
                                                <div className="flex space-x-3 items-center w-full">
                                                    <img
                                                        ...
                                                        className="sm:w-7 md:w-10"
                                                    />
                                                    <p className="sm:text-[9px] md:text-[11px]">
                                                        Size 1080x1920 or
                                                        600x800
                                                    </p>
                                                </div>
