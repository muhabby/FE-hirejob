                ...
                <body className=" my-20 lg:mx-12 2xl:mx-28">
                    <header className="flex justify-between items-center w-full">
                        ...
                        <div className="">
                            <img
                                ...
                                alt=""
                                width={700}
                                className="lg:w-[450px] 2xl:w-[700px]"
                            />
                        </div>
                    </header>
                    ...
                    <section className="mt-28 space-y-24">
                        <div className="flex justify-center">
                            <h1 className="font-semibold text-4xl text-[#1F2A36]">
                            ...
                            {SLIDES.map((data, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center text-center pt-5 gap-2">
                                        <h1 className="font-semibold text-3xl text-[#1F2A36]">
                                            {data.title}
                                        </h1>
                                        <h2 className="text-lg font-normal text-[#9EA0A5]">
                                            {data.label}
                                        </h2>
                                        <p className="w-[187px] font-normal text-lg text-[#46505C]">
                                            {data.text}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <section className="flex items-center justify-between lg:w-full 2xl:w-[1150px] h-[227px] bg-[#5E50A1] mt-60 mb-32 2xl:mx-48 rounded-tl-[40px] rounded-tr-[8px] rounded-bl-[8px] rounded-br-[40px]">
                        ...
                        <div className="mr-20 w-[210px] h-[63.11px] shadow-md rounded-md bg-white flex justify-center hover:bg-light-grey">
                            <button className="font-bold text-base text-[#796EAF]">
                                Mulai Dari Sekarang
                            </button>
                        </div>
                    </section>
            ...
            <div className="lg:hidden mx-2 w-full ">
                <nav className="flex items-center justify-between mt-5 px-2 md:px-5 ">
                    ...
                    <div className="flex items-center space-x-2">
                        <ButtonWhite
                            ...
                            className={
                                "w-20 text-[8px] h-10 flex items-center md:w-40 md:text-xs"
                            }
                        />
                        <ButtonPurple
                            text="Masuk Untuk Perekrut"
                            className={
                                "w-20 text-[8px] h-11 flex items-center md:w-40 md:text-xs"
                            }
                        />
                    </div>
                </nav>
                <body className=" my-20 mx-5 md:mx-10 ">
                    ...
                    <section className="flex flex-col justify-around mt-20 md:mt-32">
                        <div className="">
                            <h1 className="font-semibold text-3xl text-[#1F2A36] md:text-start">
                                Skill Tallent
                            </h1>
                            ...
                            <div className="flex space-x-20 pt-8 md:justify-start">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        <img src={tick2} alt="" width={24} />
                                        <p className="text-sm text-[#46505C] font-normal">
                                            10+ Bahasa lainnya
                                        </p>
                                    </div>
                                </div>
                            ...
                            {SLIDES.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center text-center pt-5 gap-2">
                                        ...
                                        <p className=" font-normal text-lg text-[#46505C]">
                                            {item.text}
                                        </p>
                                    </div>
                                </div>
